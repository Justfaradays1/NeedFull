// NeedFull frontend configuration
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' http://localhost:5000 http://localhost:3000 https://res.cloudinary.com https://needfull.onrender.com wss://needfull.onrender.com",
              "manifest-src 'self'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join("; "),
