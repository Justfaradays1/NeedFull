                  ...
                  return (
                    <div key={n.id} className="relative">
                      <button
                        ...
                        className={`tap-target w-full rounded-xl border p-3 text-left transition-all active:scale-[0.98] ${showUnread ? 'border-brand/10 bg-white shadow-sm' : 'border-transparent bg-gray-50/50'}`}
                      >
                      ...
                      {menuId === n.id && (
                        <>
                          ...
                          <div className="absolute right-2 top-2 z-50 min-w-[140px] rounded-xl border border-gray-200 bg-white py-1 shadow-lg">
                            {showUnread && (
