...
import {
  getTrustLevel,
  getTrustScoreColor,
  getTrustProgressBarColor,
  getTrustGradient,
} from "@/lib/utils/trust";
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
          ...
          {isExpanded && (
            <div className="mt-3 space-y-2 text-sm text-gray-700">
              <p>
                Your trust score is built from{" "}
                <strong>6 independent factors</strong>:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600 text-xs">
                <li>
                  <strong>Reviews (0–40pts):</strong> Weighted average of
                  ratings you've received
                </li>
                <li>
                  <strong>Completion (0–20pts):</strong> Tasks completed vs.
                  accepted + volume bonus
                </li>
                <li>
                  <strong>Verification (0–15pts):</strong> Email, phone, and
                  student ID verification
                </li>
                <li>
                  <strong>Reports (−20pts max):</strong> Penalty for unresolved
                  reports against you
                </li>
                <li>
                  <strong>Tenure (0–10pts):</strong> Account age; 1 point per
                  month (max 10)
                </li>
              </ul>
