  ...
  return (
    <>
      <nav
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(13,79,53,0.96), rgba(26,107,74,0.88))",
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-10 lg:px-24 h-20 flex items-center justify-between">
          ...
          >
            <div
              className="w-11 h-11 bg-brand rounded-xl flex items-center justify-center text-gold"
              style={{ boxShadow: "inset 0 1px 0 rgba(234,163,37,0.3)" }}
            >
              <svg viewBox="0 3 36 30" fill="none" className="w-7 h-7">
                <rect
                  x="12"
                  y="24"
                  width="16"
            ...
            <span className="font-bold text-xl leading-none font-display text-white">
              NeedFull
            </span>
          </a>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(13,79,53,0.98), rgba(26,107,74,0.95))",
          }}
        >
          <div className="px-4 pb-6 pt-2 space-y-1">
            ...
            <div className="flex items-center gap-3 px-3 pb-2">
              ...
              <a
                href="/login"
                className="flex-1 text-center border border-white/30 text-white text-sm font-semibold px-4 py-2.5 rounded-full transition-colors hover:border-white hover:bg-white/10"
              >
                Sign in
              </a>
              <a
                href="/register"
                className="flex-1 text-center bg-gold hover:bg-[#d4931f] text-white text-sm font-bold px-4 py-2.5 rounded-full transition-colors shadow-md"
              >
                Get started
              </a>
            </div>
