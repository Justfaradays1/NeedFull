export function HeroSection() {
  return (
    ...
    >
      {/* Faint grid */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.07]" style={{ backgroundImage: `linear-gradient(rgba(255,255,255,0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.2) 1px, transparent 1px)`, backgroundSize: "48px 48px" }} />
          ...
          <div>
            ...
            <div className="mt-12 grid grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                {
                  value: "<5",
                  label: "Mins to receive first offer",
                  icon: (
                    <svg
                      className="h-5 w-5"
                      fill="none"
          ...
          <div className="relative mt-16 lg:mt-0">
            <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-sm mx-auto">
              <div className="flex items-center justify-between mb-5">
                <span className="bg-brand-light text-brand text-xs font-medium px-3 py-1 rounded-full">
                  Laundry
                </span>
                <span className="text-gold font-bold text-2xl">₦1,500</span>
              </div>
              <h3
                className="font-semibold mb-3 font-display text-lg"
                style={{ color: "#171717" }}
              >
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="/register" className="ml-auto bg-gold text-white text-sm font-semibold px-6 py-2.5 rounded-full transition-all hover:brightness-105 active:scale-[0.97]">
                  Apply →
                </a>
              </div>
            </div>
